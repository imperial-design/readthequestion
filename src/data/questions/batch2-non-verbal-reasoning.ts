...
export const batch2NonVerbalReasoningQuestions: Question[] = [
...

  {
    ...
    options: [
      ...
      { text: '17', isEliminatable: true, eliminationReason: '17 adds 6 to 11. A rusher might double the gap of 3, but the pattern consistently adds just 3.' },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: '6', isEliminatable: true, eliminationReason: '6 is just the heart value alone. A rusher might pick the first shape mentioned without adding all three.' },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: '13', isEliminatable: true, eliminationReason: '13 adds 3 to 10. A rusher might see Row 2 adds 3 each time and apply the same gap, but Row 3 multiplies 5 by 1, 2, 3.' },
    ],
    correctOptionIndex: 1,
...

  {
    ...
    options: [
      ...
      { text: '12', isEliminatable: true, eliminationReason: '12 adds 4 to 8. A rusher might see the gaps increasing (1, 1, 2, 3) and guess the next gap is 4, but you add the two previous numbers: 5 + 8 = 13.' },
    ],
    correctOptionIndex: 2,
  ...
  },
  {
    ...
    options: [
      ...
      { text: '5', isEliminatable: true, eliminationReason: '5 would mean only 1 face was painted. A rusher might think "share one corner" means only one face, but three faces meet at each corner of a cube.' },
    ],
    correctOptionIndex: 1,
  ...
  },
  {
    ...
    options: [
      ...
      { text: '15', isEliminatable: true, eliminationReason: '15 might come from adding 5+4+3+2+1. But the correct count is 4+3+2+1 = 10. A rusher might start with 5 instead of 4.' },
    ],
    correctOptionIndex: 1,
  ...
  },
  {
    ...
    options: [
      ...
      { text: '14', isEliminatable: true, eliminationReason: '14 could come from using pentagon (5) instead of hexagon (6): 5+5+4. A rusher might mix up shape values.' },
    ],
    correctOptionIndex: 1,
